...
namespace BookingSystem.Infrastructure.Migrations
{
    ...
    [Migration("20230706091211_addColumnToTable")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BookingSystem.Infrastructure.Data.Models.Benefit", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BookingSystem.Infrastructure.Data.Models.Comment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BookingSystem.Infrastructure.Data.Models.HotelBenefits", b =>
                {
                    b.Property<int>("HotelId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BookingSystem.Infrastructure.Data.Models.Picture", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BookingSystem.Infrastructure.Data.Models.RentCarReservations", b =>
                {
                    ...
                    b.HasKey("RentCarId", "ReservationId");

                    b.HasIndex("ReservationId");

                    b.ToTable("RentCarReservations");
                });
            ...
            modelBuilder.Entity("BookingSystem.Infrastructure.Data.Models.RoomBasis", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BookingSystem.Infrastructure.Data.Models.RoomPackage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BookingSystem.Infrastructure.Data.Models.RoomReservations", b =>
                {
                    b.Property<int>("RoomId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BookingSystem.Infrastructure.Data.Models.RoomsBases", b =>
                {
            ...
            modelBuilder.Entity("BookingSystem.Infrastructure.Data.Models.RoomType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BookingSystem.Infrastructure.Data.Models.User", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("BookingSystem.Infrastructure.Data.Models.HotelBenefits", b =>
                {
                    b.HasOne("BookingSystem.Infrastructure.Data.Models.Benefit", "Benefit")
            ...
            modelBuilder.Entity("BookingSystem.Infrastructure.Data.Models.Room", b =>
                {
                    ...
                    b.HasOne("BookingSystem.Infrastructure.Data.Models.RoomPackage", "Package")
                        .WithMany("Rooms")
                        .HasForeignKey("PackageId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("BookingSystem.Infrastructure.Data.Models.RoomType", "RoomType")
                        .WithMany("Rooms")
            ...
            modelBuilder.Entity("BookingSystem.Infrastructure.Data.Models.RoomsBases", b =>
                {
                    b.HasOne("BookingSystem.Infrastructure.Data.Models.RoomBasis", "RoomBasis")
                        .WithMany("RoomBases")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<System.Guid>", b =>
                {
                    b.HasOne("BookingSystem.Infrastructure.Data.Models.User", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("BookingSystem.Infrastructure.Data.Models.RentCar", b =>
                {
                    b.Navigation("RentCarReservations");
                });
